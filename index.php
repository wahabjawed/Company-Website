...
<head>
    ...
    <meta property="og:image" content="http://www.avialdo.com/img/avialdo_pic.jpg" />
    ...
    <link rel="image_src" 
      type="image/png" 
      href="http://www.avialdo.com/img/avialdo_pic.jpg" />
...
<!-- Services Section -->
<section id="services" class="cbp-so-section cbp-so-init anim-vertical expand-vertical">
	<div class="container cbp-so-side cbp-so-side-top">
		<h1>Our Services</h1>
		<div class="row">
...
<section id="portfolio" class="cbp-so-section cbp-so-init">
	<div class="container cbp-so-side cbp-so-side-top">
		...
		<ul id="portfolio-grid" class="row portfolio-row">
			...
			<li class="portfolio-mix col-md-3 simulation">
				<figure class="portfolio-item">
					<a href="assets/book-mockups-big.jpg" rel="prettyPhoto[portfolio-gal]">
			...
			<li class="portfolio-mix col-md-3 simulation">
				<figure class="portfolio-item">
					<a href="assets/cream-ui-big.jpg" rel="prettyPhoto[portfolio-gal]">
			...
			<li class="portfolio-mix col-md-3 graphics">
				<figure class="portfolio-item">
					<a href="assets/bc-mockups-big.jpg" rel="prettyPhoto[portfolio-gal]">
			...
			<li class="portfolio-mix col-md-3 graphics">
				<figure class="portfolio-item">
					<a href="assets/analog-ui-big.png" rel="prettyPhoto[portfolio-gal]">
				...
				<div class="da-slide">
					<div class="da-img">
						<div class="round-outline">
							<img class="round-photo" src="assets/mary-anne1.jpg" alt="mary-anne" />
						</div>
					</div>
					<p class="block-cite">Mary Anne, Spain</p>
...
-->
				<div class="da-slide">
					<div class="da-img">
						<div class="round-outline">
							<img class="round-photo" src="assets/kebron.jpg" alt="image01" />
						</div>
					</div>
					<p class="block-cite">Kebron, Founder at <a href="http://www.viditure.com">Viditure, USA</a></p>
					<blockquote><p>Avialdo is dedicated to providing excellence. They are worth way more then what they charge. Take advantage of the opportunity to use them!</p></blockquote>
				</div>

				<div class="da-slide">
					<div class="da-img">
						<div class="round-outline">
							<img class="round-photo" src="assets/haris.jpg" alt="haris bacic" />
						</div>
					</div>
					<p class="block-cite">Haris Bacic, Founder at <a href="http://www.fastfoodmenuprices.com">FFMP, UK</a></p>
					<blockquote><p>The Work is delivered as expected. We had a good communication all along. They did revisions as requested. Very easy to deal with. Keep it up Avialdo.</p></blockquote>
				</div>
	...
	<div class="container cbp-so-side cbp-so-side-top">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<p class="contact-meta">contact@avialdo.com</p>
			</div>
			<div class="col-sm-2">
				<div class="icon">
					<i class="fa fa-phone fa-2x"></i>
				</div>
				<p class="contact-meta">+92-213-2243459</p>
			</div>
		</div>
		<div class="row">
...
<div class="footer">
	<div class="container">
		<p>© Avialdo - All rights reserved</p>
	</div>
</div>
